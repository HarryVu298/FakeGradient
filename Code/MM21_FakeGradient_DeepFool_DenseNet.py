...
def get2Dfrom3D(height, width, array):
    # Check if the array has only one channel
    if array.shape[0] == 1:
        # Duplicate the single channel to create a three-channel array
        return array[0], array[0], array[0]
    elif array.shape[0] >= 3:
        # Handle a three-channel (or more) array
        return array[0], array[1], array[2]
    else:
        raise ValueError("Array must have at least one channel")
