...
import os
import csv
from ModelModify import ModifyModel,ModifyModelVGG, ModifyModelScale
...
net2.eval()
'''
net2 = models.googlenet(pretrained=True)

#net2= ModifyModel(net2)
Scale=20
...
#
AT="DeepFool"
CSVfilenameTime ='GoogleNet'+'_'+ AT +"_"+str(Scale)+"_MethodB"+'_Result.csv'
...
GA,GB,GC=get2Dfrom3D(224,224,TheGradient)
