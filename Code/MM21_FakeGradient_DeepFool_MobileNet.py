...
net2.eval()
'''
net2 = models.mobilenet_v2(pretrained=True)
net2= ModifyModelMobNetV2Scale(net2,Scale)
net2.cuda()
net2.eval()
...
#
AT="DeepFool"
CSVfilenameTime ='mobilenet_v2'+'_'+ AT +"_"+str(Scale)+"_MethodB"+'_Result.csv'
